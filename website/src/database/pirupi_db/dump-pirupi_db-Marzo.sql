...
INSERT INTO
  `consoles`
VALUES
  (11, 'Atari', '1646353812708_consol.png'),(12, 'Family', '1646353820574_consol.png'),(13, 'N64', '1646353827936_consol.png'),(14, 'PS1', '1646353835987_consol.png'),(15, 'Sega', '1646353845924_consol.png'),(16, 'SuperNintendo', '1646353855299_consol.png');
...
INSERT INTO
  `product_colors`
VALUES
  (1, 'Rojo', '#A31915'),(2, 'Arena', '#CDB48C'),(3, 'Gris', '#706F6F'),(4, 'Negro', '#000000');
...
CREATE TABLE `products` (
    ...
    PRIMARY KEY (`id`)
  ) ENGINE = InnoDB AUTO_INCREMENT = 1646096398882 DEFAULT CHARSET = utf8mb4;
  /*!40101 SET character_set_client = @saved_cs_client */;
--
...
VALUES
  (
    1,
    ' Two Players',
    'Consola árcade con sistema integrado, lista para enchufar y poder disfrutar con amigos. ',
    45000,
    '1646103572318_product.JPG'
  ),(
    2,
    ' Dual Stick Arcade',
    'Consola 1 player con sistema integrado + joystick 1 player. ',
    35000,
    '1646103730386_product.jpeg'
  ),(
    3,
    ' Joystick Pro',
    'Stick arcade viene lista para conectar tanto como otro pirupí, PC o PSX mediante el port USB. ',
    36000,
    '1646103760316_product.jpeg'
  );
...
VALUES
  (
    ...
    'admin@gmail.com',
    'Administrador',
    '$2a$10$olrfCSdlUHVekaTf1MqX0OrHmGq2DuJiUIVBCnYPqW.UunwdN2.Qa',
    '1646412202122_avatar.png',
    1,
    'Calle falsa 123'
  ),(
    12,
    'invitado@gmail.com',
    'Invitado',
    '$2a$10$4a9GNnBxoTghWv7RudlOEu./zZY76Y.LoSqDEylOYJNu8oyLroFbG',
    '1646412458691_avatar.png',
    0,
    'Calle falsa 321'
  );
...
-- Dump completed on 2022-03-06 19:05:10